...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/06/2025 às 06:47
...
(3, 2, 3, 'ola', 0, NULL, '2025-06-25 06:40:12', '2025-06-25 06:40:12'),
...
('brvisan@gmail.com', '$2y$12$6NxhaJ.S.W/7Cmz4jInoLusCtXDQ4.v6fcBWHwth1vJNqt6pcJjVe', '2025-06-10 05:22:57'),
...
CREATE TABLE `plans` (
  ...
  `features_off` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`features_off`)),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Plano Básico', 'basico', 'Acesso essencial aos recursos.', 10.00, 0, 'month', 'price_1RRROTQZYlGh3UzqVpcHQJzq', 1, '\"[\\\"123\\\",\\\"456\\\"]\"', '[\"67\"]', '2025-05-27 06:36:45', '2025-06-25 05:09:07'),
(2, 'Plano Premium', 'premium', 'Acesso completo e suporte prioritário.', 20.00, 0, 'month', 'price_1RTEFZQZYlGh3UzqyX7ZoWOx', 1, '[\"123\"]', NULL, '2025-05-27 06:36:45', '2025-06-25 05:04:15');
...
('i80jcfHDgDP9NdfX21y1NnAZQgy0W94w5kp8RaSt', 5, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36', '', 1750825418),
('lcbPok7GVDNstcX2cqG1j7d1o69Dn9LBVTPqiH0w', 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36 OPR/119.0.0.0', '', 1750825358);
