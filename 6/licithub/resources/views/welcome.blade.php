...
<header class="header" id="header">
  <div class="container">
    ...
    @if ($user->user_type === 'customer' && $user->noCashierSubscription())
        <a href="{{ route('subscriptions.index') }}" class="btn btn-primary">Assine já</a>
    @endif
...
@endif
  ...
  <section class="hero" id="home">
    ...
    <!-- O usuário ESTÁ logado -->
          ...
          <a href="{{ route('login') }}" class="btn btn-primary btn-lg">Começar agora</a>
          @endif
                    ...
                    <div class="pricing-footer">
                        @auth
                            @if(auth()->user()->user_type === 'customer' && !auth()->user()->hasActiveCashierSubscription())
                                <a href="{{ route('subscriptions.index') }}" class="btn {{ $loop->index == 1 ? 'btn-primary' : 'btn-outline' }} btn-block">
                                    Escolher Plano
                                </a>
                            @endif
                        @else
