...
{{-- @if ($user && $user->subscriptions->where('status', 'active')->count() > 0)
    <p>Você está subscrito!</p>
@endif --}}
...
<header class="header" id="header">
  <div class="container">
    ...
    @if ($user->user_type === 'customer' && $user->noCashierSubscription())
        <a href="#planos" class="btn btn-primary">Assine já</a>
    @endif
  ...
  <section class="counter-section">
    <div class="container">
      <div class="counter-grid">
        ...
        <div class="counter-item">
          <div class="counter-number" data-count="60">0</div>
    ...
    <div class="container">
        ...
        <div class="pricing-grid">
            @foreach($plans as $plan)
                <div class="pricing-card {{ $loop->iteration == ceil($plans->count()/2) ? 'popular' : '' }}">
                    @if($loop->iteration == ceil($plans->count()/2))
                    ...
                    <div class="pricing-header">
                        ...
                        <div class="pricing-price">
                            <span class="price">R$ {{ number_format($plan->price, 2, ',', '.') }}</span>
                            <span class="period">/{{ $plan->interval == 'month' ? 'mês' : 'ano' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="pricing-footer">
                        @auth
                            @if(auth()->user()->user_type === 'customer' && !auth()->user()->hasActiveCashierSubscription())
                            <a href="{{ route('subscriptions.checkout', $plan->id) }}" class="btn {{ $loop->index == 1 ? 'btn-primary' : 'btn-outline' }} btn-block btn-subscribe">
    Escolher Plano
</a>
                            @endif
                        @else
                            <a href="{{ route('register') }}" class="btn {{ $loop->index == 1 ? 'btn-primary' : 'btn-outline' }} btn-block">
                                Cadastre-se
                            </a>
                        @endauth
                    </div>
      ...
      <div class="footer-grid">
        <div class="footer-col">
          ...
          <div class="social-links">
            ...
            <a href="https://wa.me/5547984826243" class="social-link">
        ...
        <div class="footer-col">
          ...
          <ul class="contact-info">
            ...
            <li><i class="fas fa-phone"></i> (47) 98482-6243</li>
