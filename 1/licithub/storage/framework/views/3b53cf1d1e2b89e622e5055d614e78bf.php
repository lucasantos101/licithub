...
<?php if($user && $user->subscriptions->where('status', 'active')->count() > 0): ?>
...
<header class="header" id="header">
  <div class="container">
    ...
    <a href="<?php echo e(route('client.dashboard')); ?>" class="btn btn-primary">Dashboard</a>
    <?php endif; ?>

    <?php if($user->user_type === 'customer' && $user->noCashierSubscription()): ?>
        <a href="<?php echo e(route('subscriptions.index')); ?>" class="btn btn-primary">Assine já</a>
    <?php endif; ?>
...
<?php else: ?>
    ...
    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline">Entrar</a>
...
</html><?php /**PATH C:\xampp\htdocs\dashboard\licithub\resources\views/welcome.blade.php ENDPATH**/ ?>