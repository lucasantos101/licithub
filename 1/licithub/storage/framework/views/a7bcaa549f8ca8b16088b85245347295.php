...
<body class="dark-mode">
    ...
    <div class="page-header">
        ...
        <div class="header-actions">
            <a href="<?php echo e(route('admins.create')); ?>" class="btn btn-success">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="user-info">
                                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($admin->name)); ?>&background=random&color=fff" 
                                         alt="<?php echo e($admin->name); ?>" class="user-avatar">
                                    <span><?php echo e($admin->name); ?></span>
                                </div>
                            </td>
                            <td><?php echo e($admin->email); ?></td>
                            <td>
                                <span class="badge <?php echo e($admin->user_type === 'admin' ? 'badge-primary' : 'badge-secondary'); ?>">
                                    <?php echo e($admin->user_type); ?>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="<?php echo e(route('admins.show', $admin)); ?>" class="btn btn-sm btn-info" title="Visualizar">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('admins.edit', $admin)); ?>" class="btn btn-sm btn-warning" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('admins.destroy', $admin)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\dashboard\licithub\resources\views/admin/admins/index.blade.php ENDPATH**/ ?>